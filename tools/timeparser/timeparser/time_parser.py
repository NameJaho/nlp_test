...
try:
    ...
    from .helper import bracket, bracket_absence, absence
    from .chinese_parser import ChineseParser
...
class TimeParser(object):
    ...
    def _preprocess(self, _filter=False):
        # 20世纪 key值
        ...
        self.chinese_parser = ChineseParser()
    ...
    def _preprocess_regular_expression(self):
        ...
        self.fixed_solar_holiday_dict = {
            ...
            '八一': [8, 1], '建军节': [8, 1], '教师节': [9, 10], '国庆节': [10, 1], '双十一': [11, 11],
            ...
            '三.一五': [3, 15], '三·一五': [3, 15], '双11': [11, 11], '双12': [12, 12], '双十二': [12, 12],
            '618': [6, 18],
            '六一八': [6, 18],
        }
    ...
    def __call__(self, time_string, time_base=time.time(), time_type=None,
        ...
        # 打印清洗后的时间字符
        # print("after cleaning:", time_string)
    ...
    def parse_time_delta_span(self, time_string, time_type=None):
        ...
        # print(first_time_string, second_time_string)
    ...
    def _char_num2num(self, char_num):
        ...
        :return:
        """
        res_num = self.chinese_parser(char_num, ret_format='str')
        if res_num is None:
            return 0
        else:
